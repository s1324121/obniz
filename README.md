...
注意事項
このシステムを動かすには、有効な GOOGLE_URL（GASのウェブアプリURL）が必要です。

LINEに通知を送る際は、LINE Developersで取得したユーザーIDの設定を確認してください。

💡 GitHubに画像を載せるコツ
GitHubのリポジトリに、お持ちの Screenshot 2026-05-29 101541.png をアップロードします。

READMEの中で ![説明文](画像のパス) と書くと表示されます。

例：同じフォルダに置いたなら ![main_screen](./Screenshot 2026-05-29 101541.png)
